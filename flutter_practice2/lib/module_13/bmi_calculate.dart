      ...
      body: ListView(
        ...
        children: [
          Padding(
            ...
            child: Text('Weight Unit', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
          ),
          AppInputField(controller: TextEditingController(),
          ...
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text('Select Height Type', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
          ),
          ...
          if(heightType == HeightType.cm)...[
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text('Height Unit',  style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
            ),
            Row(
              children: [
                Expanded(child:  AppInputField(controller: TextEditingController(),
